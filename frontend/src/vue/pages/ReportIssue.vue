<template>
  ...
  >
    <table class="">
      <tbody>
        <tr>
          <th><label for="reportIssueIssue">Git版本</label></th>
          <td>
            <input
              :value="git"
              class="input"
        ...
        <tr>
          <th><label for="reportIssueIssue">发现的问题:</label></th>
          <td>
            <textarea
              id="reportIssueIssue"
              ref="textarea"
        ...
        <tr>
          <th><label for="reportIssueBrowserVersion">受影响的浏览器:</label></th>
          <td>
            <input
...
export default class ReportIssue extends Vue {
  ...
  public async submit() {
    ...
    this.$store.growlSuccess("问题已成功提交");
    this.$router.go(-1);
  }
}
</script>
